...
export const CONFIG_SCHEMA: {
  ...
  { key: "feProfile", group: "World", type: "string", default: '"fe-7.4"', label: "Compatibility profile", hint: "fe-7.4 is the active edition." },
  { key: "tibiaProtocol", group: "World", type: "string", default: '"7.4"', label: "Tibia protocol", hint: 'Quoted string; use "7.4" for the fe-7.4 edition.', advanced: true },

  {
    key: "otclientV8ProtocolVersion",
    group: "Player visibility & client protocol",
    type: "number",
    default: "760",
    label: "Client protocol",
    hint: "Use 760 - stock OTCv8 discards ALL chat/Look text below 760. Clients may connect as 740 or 760 regardless of this value.",
  },
  {
    key: "otclientV8PlayerLookType",
    group: "Player visibility & client protocol",
    type: "number",
    default: "128",
    label: "Player outfit (look type)",
    hint: "128 is the classic citizen. Zero renders players invisible.",
  },
  {
    key: "otclientV8OutfitFirstLookType",
    group: "Player visibility & client protocol",
    type: "number",
    default: "128",
    label: "Outfit chooser first look type",
  },
  {
    key: "otclientV8OutfitLastLookType",
    group: "Player visibility & client protocol",
    type: "number",
    default: "134",
    label: "Outfit chooser last look type",
  },
  {
    key: "otclientV8EmptyWorldGroundThingId",
    group: "Player visibility & client protocol",
    type: "number",
    default: "102",
    label: "Ground tile sprite ID",
    hint: "102 is the classic grass tile in your client's dat file.",
  },
  ...
  { key: "otclientV8PlayerSpeed", group: "OTClientV8 native", type: "number", default: "220", label: "Base player speed", hint: "Level-1 base speed; dynamic per-player speed (level curve, boots) arrives with the movement upgrade.", advanced: true },
